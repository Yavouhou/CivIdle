export const FR = {
   ...
   AccountSupporter: "Détenteur du Supporter Pack",
   ...
   Aeschylus: "Eschyle",
   Agamemnon: "Agamemnon",
   AGreatPersonIsBorn: "Un personnage illustre apparaît",
   ...
   AlanTuringDesc: "+%{value} de Science des Ouvriers inactifs",
   AlbertEinstein: "Albert Einstein",
   Alcohol: "Alcool",
   AldersonDisk: "Alderson Disk",
   AldersonDiskDesc: "+25 Bonheur. Cette merveille peut être améliorée et chaque amélioration successive génère +5 Bonheur",
   Alloy: "Alliage",
   Alps: "Alpes",
   ...
   Broadway: "Broadway",
   BroadwayDesc: "Un personnage illustre de l'ère actuelle et un autre de l'ère précédente apparaissent. Une fois le choix entre les deux fait, son effet est doublé",
   BronzeAge: "Âge de bronze",
   BronzeTech: "Bronze",
   BuddhismLevelX: "Bouddhisme %{level}",
   Build: "Bâtir",
   ...
   BuildingEmpireValue: "Valeur totale de l'Empire",
   ...
   CannotEarnPermanentGreatPeopleDesc: "Vous ne pouvez pas obtenir de personnage illustre permanent car vous êtes en mode difficile",
   ...
   ChoghaZanbilDescV2: "Choisissez une tradition d'Empire, débloquez davantage de bonus avec chaque amélioration",
   ...
   CloneFactory: "Usine de clones",
   CloneFactoryDesc: "Copie n'importe quelle ressource",
   CloneLab: "Clone Lab",
   CloneLabDesc: "Transforme n'importe quelle ressource en Science",
   CloneLabScienceMultiplierHTML: "Les Multiplicateurs de Production <b>qui ne s'appliquent qu'aux bâtiments produisant de la Science</b> (comme les bonus de l'Atomium) <b>ne s'appliquent pas</b> au Clone Lab",
   Cloth: "Tissu",
   ...
   Colosseum: "Colisée",
   ColosseumDesc: "Le fonctionnement des fabriques de Chars vous coûte 1 Bonheur de moins que d'habitude. Consomme 10 Chars et produit 10 Bonheur",
   ColossusOfRhodes: "Colosse de Rhodes",
   ColossusOfRhodesDesc: "Tous les bâtiments adjacents qui ne produisent pas d'Ouvrier gagnent +1 Bonheur",
   ...
   ConstructionPriority: "Priorité de construction",
   ...
   ContentInDevelopmentDesc: "Le contenu de ce jeu est toujours en développement et sera disponible grâce à une nouvelle mise à jour. Suivez les mises à jour !",
   Copper: "Cuivre",
   ...
   DynamicMultiplierTooltip: "Ce multiplicateur est dynamique, ni les Ouvriers ni le stockage ne seront affectés",
   Dynamite: "Dynamite",
   DynamiteWorkshop: "Fabrique de dynamite",
   DysonSphere: "Dyson Sphere",
   DysonSphereDesc: "Tous les bâtiments obtiennent +5 Multiplicateur de Production. Cette merveille peut être améliorée et chaque amélioration génère +1 Multiplicateur de Production à tous les bâtiments",
   Education: "Éducation",
   ...
   EmpireValueFromBuilding: "Valeur d'Empire issue des bâtiments",
   EmpireValueFromBuildingsStat: "Bâtiments",
   EmpireValueFromResources: "Valeur d'Empire issue des ressources",
   EmpireValueFromResourcesStat: "Ressources",
   ...
   EuphratesRiver: "Le fleuve Euphrate",
   EuphratesRiverDesc:
      "Chaque tranche de 10% d'Ouvriers actifs en production (non en transport) génère +1 Multiplicateur de Production à tous les bâtiments qui ne produisent pas d'Ouvrier (max = nombre d'ères débloquées / 2). Lorsque les Jardins Suspendus sont construit à côté, ces derniers obtiennent +1 d'effet pour chaque ère au-delà de celui débloquant les Jardins Suspendus. Lorsque l'Euphrate est découvert, fait apparaître la ressource Eau sur toutes ses cases adjacentes qui n'ont pas de ressource.",
   ...
   FreeThisWeekDescHTML: "<b>Chaque semaine</b>, l'une des villes premium est disponible gratuitement. La ville gratuite de cette semaine est <b>%{city}</b>",
   Frigate: "Frégate",
   ...
   GoldMiningCamp: "Mine d'or",
   GordonMoore: "Gordon Moore",
   GrandBazaar: "Grand Bazar",
   GrandBazaarDesc: "Permet de gérer tous vos marchés. Les caravansérails adjacents gagnent +5 Production et Multiplicateur de Stockage. Les marchés adjacents obtiennent tous des échanges différents.",
   ...
   GreatDagonPagodaDescV2: "Toutes les Pagodes sont exemptées du -1 Bonheur. Génère de la Science à parti de la production de Foi de toutes les Pagodes",
   ...
   GreatPeoplePickPerRoll: "Sélection de Personnages illustres par tour",
   ...
   GreatPersonLevelRequired: "Niveau requis du Personnage Illustre Permanent",
   GreatPersonLevelRequiredDesc: "La réincarnation sur la carte %{city} nécessite %{required} niveaux de Personnages illustres permanents. Vous avec actuellement %{current}",
   GreatPersonOnlyIn: "Ce Personnage illustre n'apparaît que sur la carte %{city}",
   ...
   HagiaSophiaDescV2: "+5 Bonheur. Les bâtiments à 0% de Capacité de Production sont exemptés du -1 Bonheur. Durant l'amorçage du jeu, génère du Bonheur supplémentaire pour éviter les arrêts de production.",
   ...
   Hollywood: "Hollywood",
   HollywoodDesc: "+5 Bonheur. +1 Bonheur pour chaque bâtiment bien approvisionné qui consomme ou produit de la Culture dans un rayon de 2 cases.",
   ...
   IMPei: "I. M. Pei",
   IMPeiDesc: "+%{value} Multiplicateur de capacité de construction",
   ...
   InternationalSpaceStationDesc: "Tous les bâtiments obtiennent +5 Multiplicateur de stockage. Cette merveille peut être améliorée et chaque amélioration supplémentaire génère +1 Multiplicateur de stockage à tous les bâtiments.",
   Internet: "Internet",
   InternetServiceProvider: "Fournisseur d'accès à Internet",
   InverseSelection: "Inverseur",
   Iron: "Fer",
   IronAge: "Âge de fer",
   Ironclad: "Cuirassé",
   IroncladBuilder: "Constructeur de cuirassés",
   IronForge: "Forge d'outils en fer",
   IronMiningCamp: "Mine de fer",
   IronTech: "Fer",
   IsaacNewton: "Isaac Newton",
   IsaacNewtonDescV2: "+%{value} Science de la part de tous les Ouvriers si plus de 50% d'entre eux sont actifs et moins de 50% des actifs font du transport.",
   ...
   Islam5UpgradeHTML: "Lorsque débloqué, génère une fois une quantité de Science équivalente au coût de la technologie <b>Industrielle</b> débloquée la plus chère.",
   ...
   JohnVonNeumannDesc: "+%{value} Science provenant des Ouvriers Actifs",
   ...
   KarlMarx: "Karl Marx",
   Knight: "Chevalier",
   KnightCamp: "Campement de chevaliers",
   LandTrade: "Commerce foncier",
   Language: "Langue",
   Law: "Loi",
   Lens: "Lentille",
   ...
   LouisSullivanDesc: "+%{value} Multiplicateur de capacité de construction",
   Lumber: "Bois d'œuvre",
   LumberMill: "Scierie",
   LuxorTemple: "Temple d'Amon",
   LuxorTempleDescV2: "+1 Science provenant des Ouvriers actifs. Sélectionnez une religion d'Empire, débloquez davantage de bonus avec chaque amélioration",
   Machinery: "Machinerie",
   Magazine: "Revue",
   MagazinePublisher: "Éditeur de revues",
   Maglev: "Maglev",
   MaglevFactory: "Usine à Maglev",
   MahatmaGandhi: "Mahatma Gandhi",
   ManagedImport: "Importation automatisée",
   ManagedImportDescV2: "Ce bâtiment importera automatiquement les ressources produites dans un rayon de %{range} cases. La gestion manuelle des ressources est désactivée. La distance maximale de transport sera ignorée",
   ...
   MarinaBaySandsDesc: "Tous les bâtiments obtiennent +5 Multiplicateur de capacité des Ouvriers. Cette merveille peut être améliorée et chaque amélioration génère +1 Multiplicateur de capacité des Ouvrier à tous les bâtiments",
   Market: "Marché",
   ...
   MatrioshkaBrainDesc: "Permet d'inclure la Science dans le calcul de la Valeur d'Empire (5 Science = 1 Valeur d'Empire). +5 Science par Ouvrier. Cette merveille peut être améliorée et chaque amélioration génère +1 Science par Ouvrier.",
   ...
   MogaoCavesDescV3: "+1 Bonheur par tranche de 10% d'Ouvriers actifs. Tous les bâtiments adjacents qui produisent de la Foi sont exemptés de -1 Bonheur.",
   ...
   MoveBuildingSelectTileToastHTML: "Sélectionnez <b>une case explorée et vide</b> sur la carte",
   Movie: "Film",
   MovieStudio: "Studio de tournage",
   Museum: "Musée",
   Music: "Musique",
   MusiciansGuild: "Guilde des musiciens",
   MutualAssuredDestruction: "Destruction mutuelle assurée",
   MutualFund: "Fonds de placement",
   Name: "Nom",
   ...
   NuclearSubmarineYard: "Chantier de sous-marin nucléaires",
   ...
   OpenLogFolder: "Ouvrir le dossier de Log",
   ...
   PalmJumeirahDesc: "+10 Capacité de construction. Cette merveille peut être améliorée et chaque amélioration génère +2 Capacité de construction",
   Pantheon: "Panthéon",
   PantheonDescV2: "Tous les bâtiments dans un rayon de 2 cases obtiennent +1 Capacité d'Ouvriers et Multiplicateur de stockage. Genère de la Science selon la production de Foi de tous les Sanctuaires",
   Paper: "Papier",
   ...
   PercentageOfProductionWorkers: "Pourcentage d'Ouvriers de production",
   ...
   PetraOfflineTimeReconciliation: "Vous avez obtenu %{count} distortion(s) après calcul du temps hors ligne auprès du serveur.",
   Petrol: "Essence",
   ...
   PlayerTradeCancelDescHTML: "Vous récupérerez <b>%{res}</b> après avoir annulé cet échange : <b>%{percent}</b> facturés pour remboursement et <b>%{discard}</b> jetés en raison du sur-stockage. <br><b>Voulez-vous vraiment annuler ?</b>",
   PlayerTradeCancelTrade: "Annuler l'échange",
   PlayerTradeClaim: "Récupérer",
   PlayerTradeClaimAll: "Tout récupérer",
   PlayerTradeClaimAllFailedMessageV2: "Impossible de récupérer les échanges - le stockage est-il plein ?",
   ...
   PlayerTradeClearAll: "Effacer tous les remplissages",
   PlayerTradeDisabledBeta: "Vous ne pourrez créer d'échange avec les joueurs qu'une fois la version beta mise en ligne.",
   PlayerTradeFill: "Vendre",
   PlayerTradeFillAmount: "Quantité en vente",
   PlayerTradeFillAmountMaxV2: "Remplir intégralement",
   PlayerTradeFillBy: "Joueur",
   PlayerTradeFillPercentage: "Taux de remplissage",
   PlayerTradeFillSuccessV2: "<b>%{success}/%{total}</b> échanges ont été complétés. Vous avez payé <b>%{fillAmount} %{fillResource}</b> et reçu <b>%{receivedAmount} %{receivedResource}</b>",
   ...
   PlayerTradeMaxAll: "Maximiser tous les remplissages",
   PlayerTradeMaxTradeAmountFilter: "Quantité maximale",
   ...
   Poem: "Poésie",
   Politics: "Politique",
   PolytheismLevelX: "Polythéisme %{level}",
   ...
   ProductionPriorityDescV2: "Une priorité plus haute signifie que le transport de ressources de ce bâtiment est prioritaire devant d'autre bâtiments. Un nombre plus élevé est davantage prioritaire",
   ...
   PromotionGreatPersonDescV2: "Lorsque consommé, promeut n'importe quel Personnage illustre permanent de la même ère à l'ère suivante.",
   ProphetsMosque: "La mosquée du Prophète",
   ProphetsMosqueDesc: "Double l'effet d'Harun al-Rashid. Génère de la Science selon la production de Foi de toutes les Mosquées.",
   Province: "Province",
   ...
   ReligionDescHTML: "Choisir <b>le Christianisme, l'Islam, le Bouddhisme ou le Polythéisme</b> pour en faire votre religion d'Empire. Vous <b>ne pourrez pas changer de religion</b> une fois le choix fait. Débloquez des bonus uniques selon la religion choisie.",
   ReligionIslam: "Islam",
   ...
   RequiredWorkersTooltipV2: "Le nombre requis d'Ouvriers pour la production est égale à la somme de toutes les ressources consommées et produites une fois les bonus de multiplication appliqués (les multiplicateurs dynamiques sont exclus)",
   ...
   ResourceBarShowUncappedHappiness: "Afficher le Bonheur illimité",
   ResourceCloneTooltip: "Le Multiplicateur de production s'applique uniquement aux ressources clonées (par exemple la copie supplémentaire)",
   ResourceColor: "Couleur des ressources",
   ResourceExportBelowCap: "Exporter sous le seuil",
   ResourceExportBelowCapTooltip: "Permet aux autres bâtiments de déplacer une ressource depuis ce bâtiment même si la quantité est sous le seuil fixé.",
   ResourceExportToSameType: "Exporter vers les bâtiments identiques",
   ResourceExportToSameTypeTooltip: "Permet aux autres bâtiments identiques de déplacer une ressource depuis ce bâtiment.",
   ...
   ScrollSensitivity: "Sensibilité de la molette de la souris",
   ScrollSensitivityDescHTML: "Ajuster la sensibilité de la molette de la souris. <b>Le paramètre doit être entre 0.01 et 100, la valeur par défaut étant 1.</b>",
   ...
   SeaTradeUpgrade: "Permet de commercer avec des joueurs par-delà la mer. Taxe pour chaque case de mer : %{tariff}",
   ...
   ShenandoahDescV2: "Les bâtiments débloqués appartenant à l'ère actuelle gagnent +2 Multiplicateur de Production. Double l'effet de J.P. Morgan",
   Shortcut: "Raccourcis",
   ...
   Software: "Logiciel",
   SoftwareCompany: "Producteur de logiciels",
   Sound: "Son",
   ...
   StatisticsStalledTransportation: "Transports au point mort",
   ...
   StPetersBasilicaDescV2: "Toutes les Églises obtiennent +5 Multiplicateuer de stockage. Génère de la Science selon la production de Foi de toutes les Églises.",
   ...
   TheMet: "The Metropolitan Museum of Art",
   ...
   TotalScienceRequired: "Total en Science nécessaire",
   ...
   TowerOfBabelDesc: "+2 Multiplication de Production à tous les bâtiments qui ont au moins un bâtiment identique actif et adjacent à la merveille.",
   ...
   TutorialAdvices:
      "Nous avons requis l'avis de joueurs expérimentés pour fournir des conseils aux nouveaux joueurs. Voici quelques conseils très utiles à lire avant de rejoindre l'aventure.<ol><li><b>N'augmentez pas tous vos bâtiments en même temps</b>: un bâtiment en cours d'amélioration ne produit pas</li><li><b>Soyez attentifs au Bonheur de votre Empire</b>: un Bonheur négatif réduit le nombre d'Ouvriers disponibles, et à -50 toute la prodcution est arrêtée</li><li><b>Ne vous développez pas trop ou trop vite</b>: les bâtiments nécessitent du Bonheur pour fonctionner. Assurez-vous d'avoir assez de Bonheur pour construire de nouveaux bâtiments</li><li><b>Priorisez les Maisons, Appartements et Copropriétés</b>: les mettre en priorité élevée permet d'éviter de fortes variations du nombre d'Ouvriers</li><li><b>Vous pouvez vous réincarner à n'importe quel moment dans votre bâtiment d'Empire</b>: il est normal de redémarrer si vous avez raté votre première tentative !</li></ol>",
   TutorialPlayerFlag: "Choisissez votre drapeau",
   TutorialPlayerHandle: "Choisissez votre pseudo",
   TV: "TV",
   TVStation: "Chaîne de télévision",
   UnclaimedGreatPersonPermanent: "Il vous reste des <b>Personnages illustres permanents</b> à collecter, cliquez ici pour les récupérer",
   UnclaimedGreatPersonThisRun: "Il vous reste des <b>Personnages illustres</b> à collecter <b>dans cette partie</b>, cliquez ici pour les récupérer",
   UnexploredTile: "Case inexplorée",
   UNGeneralAssemblyCurrent: "Assemblée générale des Nations Unies en cours #%{id}",
   UNGeneralAssemblyMultipliers: "<b>+%{count}</b> Production, Capacité des Ouvriers et Multiplicateur de Stockage pour <b>%{buildings}</b>",
   ...
   UnlockXHTML: "Débloquer <b>%{name}</b>",
   Upgrade: "Améliorer",
   ...
   UpgradeWonderNotProducingDesc: "Cette merveille est en train d'être améliorée - <b>bonus désactivé(s) jusqu'à ce que l'amélioration soit terminée</b>",
   Uranium: "Uranium",
   ...
   WallOfBabylon: "Remparts de Babylone",
   WallOfBabylonDesc: "Tous les bâtiments obtiennent +N Multiplicateur de stockage. N = nombre d'ères débloqués / 2",
   ...
   WarehouseExtension: "Débloque le mode Extension d'Entrepôt et de Caravansérail. Permet aux Entrepôts adjacents aux Caravansérails d'être inclus dans le commerce entre joueurs",
   ...
   WildCardGreatPersonDescV2: "Lorsque consommé, devient n'importe quel Personnage illustre de la même ère",
   ...
   ZagrosMountainsDesc: "Tous les bâtiments adjacents qui ont moins de 5 Multiplication de Production obtiennent +2 Multiplication de Production. Double l'effet de Nabuchodonozor II (Personnage illustre)",
   Zenobia: "Zénobie",
   ZenobiaDesc: "+%{value}h de distortion temporelle stockée à Pétra",
   ZhengHe: "Zheng He",
   ZigguratOfUr: "Ziggurat of Ur",
   ZigguratOfUrDesc: "Pour chaque tranche de 10 Bonheur (plafonné), génère +1 Multiplicateur de Production à tous les bâtiments (max = nombre d'ères débloquées / 2). Les Merveilles (y compris naturelles) ne génèrent plus +1 Bonheur. L'effet peut être désactivé.",
   Zoroaster: "Zoroastre",
};
